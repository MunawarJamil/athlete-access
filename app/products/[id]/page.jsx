...
import { product_sec_row } from "@/app/data/product-data";
          ...
          <div className=" container   mx-auto flex flex-wrap">
            ...
            <div className="  w-full lg:w-1/2    md:pl-10 md:py-6 mt-6 md:mt-0">
              ...
              <div className="flex">
                ...
                <button className="flex ml-5  text-white bg-blue-700 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded"
                 > <Link href='/cart'>
                  Add To Cart
                  </Link>
                </button>
