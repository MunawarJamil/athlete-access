...
{/* ================================================================================================= */}
  <div className=" col-span-10 ml-10 md:mx-auto pb-6 md:col-span-12  xl:col-span-4  w-full max-xl:px-6 max-w-3xl xl:max-w-2xl mx-auto lg:p-8  mt-20 max-h-auto bg-gray-50   ">
              ...
              <form>
                ...
                <div className="flex pb-6">
                  <div className="relative w-full">
                    ...
                    <button
                      ...
                      className="dropdown-toggle flex-shrink-0   inline-flex items-center py-4 px-4 text-base font-medium text-center text-gray-900 bg-transparent  absolute right-0 top-0 pl-2 "
                      type="button"
                    >
                      <svg
                    ...
                    <div
                      ...
                      className="  hidden  divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 absolute top-10 bg-white right-0"
                    >
                      <ul
                ...
                <div className="flex pb-4 w-full">
                  <div className="relative w-full ">
                    ...
                    <div
                      id="dropdown"
                      className="absolute top-10 right-0  hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700"
                    >
                      <ul
                        className="py-2 text-sm text-gray-700 dark:text-gray-200"
                        aria-labelledby="dropdown-button"
